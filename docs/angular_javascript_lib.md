...
<head>
    ...
    <script src="scripts/BibcodeQueryLib/Models/ReturnBibcodeModel.js"></script>
...
```js
	app.controller("testController", function($scope, BibcodeQueryBindingController, ReturnBibcodeModel){
	});
```
